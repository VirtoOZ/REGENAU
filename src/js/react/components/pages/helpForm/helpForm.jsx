		...
		<>
			<section className="help">
				<div className="help__container">
					<div className="help__wrapper">
						...
						<div className="help__body">
							<form className="help__form help-form" action="" method="post">
								<div className="help-form__title">Помочь в выборе и расчете материалов</div>
					...
					<img className='help__bg' src="@img/main/help-form/bg.png" alt="фоновая картинка формы" />
					{/* </div> */}
				</div>
				<div className="help-bottom__container">
					<div className="help-bottom__image"></div>
					<div className="help-bottom__body info">
						<div className="help-bottom__info info__item">
